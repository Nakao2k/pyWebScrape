...
PARAM_PROTOCOL = "http://"
PARAM_XPATH_LOGINID = ''
PARAM_XPATH_LOGINPASSWORD = '//*[@id="Password"]'
PARAM_NAME_SESSIONID = "Gambit"

# Loginボタンのxpath
PARAM_XPATH_LOGINBUTTON = '//*[@id="button_Login"]'

# Loginページ
PARAM_LOGIN_PAGE = ""

# Logoutページ
PARAM_LOGOUT_PAGE = "iss/specific/logout.html"
...
# ホスト名が書かれたWebページ
PARAM_HOST_PAGE = "iss/specific/sysInfo.html"
PARAM_XPATH_HOSTNAME = '//*[@id="tbl1"]/tbody/tr[2]/td[2]/input'
...
if __name__ == '__main__':
    ...
    try:
        ...
        hostname = elem.get_attribute("value")
