...
# 出力フォルダ
PARAM_OUTDIR = "Netgear"
# 接続プロトコル 通常はhttp or https
PARAM_PROTOCOL = "http://"
PARAM_XPATH_LOGINID = '//*[@id="login_contenter"]/div/div[1]/div[2]/input'
PARAM_XPATH_LOGINPASSWORD = '//*[@id="login_contenter"]/div/div[2]/div[2]/input'
PARAM_NAME_SESSIONID = ""

# LoginボタンのHTMLタグ属性。必ずどちらかに値を入れる。空白であれば無視される。
PARAM_XPATH_LOGINBUTTON = '//*[@id="login_contenter"]/div/div[3]/div[2]/button'
...
# ホスト名が書かれたWebページ
PARAM_HOST_PAGE = "systeminfo"
PARAM_XPATH_HOSTNAME = '//*[@id="tr0"]/tr[2]/td[2]'
...
if __name__ == '__main__':
    ...
    try:
        ...
        # ma = re.search(PARAM_REGEX_HOSTNAME, driver.page_source, flags=re.MULTILINE)
        # if ma is None:
        #     print("Failed to get the hostname")
        #     exit(1)
        #
